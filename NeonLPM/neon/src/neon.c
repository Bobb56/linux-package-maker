...
void loadFunctions(NeonEnv* env)
{
    ...
    Function builtinfunctions[] = {
        ...
        (Function) {
            .ptr = _copyPath_,
            .help = "Copies a file or folder into destination",
            .nbArgs = 2,
            .typeArgs = (int[]){TYPE_STRING, TYPE_STRING},
            .typeRetour = TYPE_NONE
        },
        (Function) {
            .ptr = _makeDirectory_,
            .help = "Creates a directory and intermediate directories",
            .nbArgs = 1,
            .typeArgs = (int[]){TYPE_STRING},
            .typeRetour = TYPE_BOOL
        },
        (Function) {
            .ptr = _deletePath_,
            .help = "Deletes a file or folder",
            .nbArgs = 1,
            .typeArgs = (int[]){TYPE_STRING},
            .typeRetour = TYPE_BOOL
        },
        (Function) {
            .ptr = _getHomePath_,
            .help = "Returns path to home directory",
            .nbArgs = 0,
            .typeArgs = NULL,
            .typeRetour = TYPE_STRING
        },
        (Function) {
            .ptr = _makeExecutable_,
            .help = "Makes a file executable",
            .nbArgs = 1,
            .typeArgs = (int[]){TYPE_STRING},
            .typeRetour = TYPE_BOOL
        },
        (Function) {
            .ptr = _getCurrentPath_,
            .help = "Returns current folder where is stored the program",
            .nbArgs = 0,
            .typeArgs = NULL,
            .typeRetour = TYPE_STRING
        },
