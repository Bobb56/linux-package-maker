...
```
wget https://github.com/Bobb56/linux-package-maker/releases/download/1.4/Linux_Package_Maker_installer.lpk && chmod +x Linux_Package_Maker_installer.lpk && ./Linux_Package_Maker_installer.lpk
```
